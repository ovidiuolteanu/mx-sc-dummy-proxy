...
const WASM_PATH: &str = "output/dummy-proxy.wasm";

struct ContractSetup<ContractObjBuilder>
where
    ContractObjBuilder: 'static + Copy + Fn() -> dummy_proxy::ContractObj<DebugApi>,
{
...
#[test]
fn deploy_test() {
    let mut setup = setup_contract(dummy_proxy::contract_obj);
